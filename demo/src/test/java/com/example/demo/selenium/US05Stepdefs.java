...
public class US05Stepdefs {
    ...
    public void elUsuarioNoHaIniciadoSesionYSeEncuentraEnLaPaginaDeAnuncios() {

        // Carga la pagina
        webDriver.get("https://roomiesfrontend.web.app/");
        // --Maximiza la ventana
        webDriver.manage().window().maximize();
        webDriver.findElement(By.xpath("//*[@id=\"app\"]/div/header/div/div[2]/span/span/a[1]")).click();

    }


    @Then("aparece un mensaje que incida iniciar sesion")
    public void apareceUnMensajeQueIndicaIniciarSesion() {
        String title=webDriver.getTitle();
        Assertions.assertEquals("Iniciar Sesión", title);
    }
}
